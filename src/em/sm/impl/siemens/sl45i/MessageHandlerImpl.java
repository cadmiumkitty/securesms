...
public class MessageHandlerImpl implements MessageHandler {
         ...
         */
         public void init() throws SecureMessengerException {
             ...
             connection = new Connection("SMS:" 
                    + EncDec.normalizeAddressString(number));
    ...
    public synchronized void setTranscriptor(
    ...
    public synchronized void setIncomingMessageStore(
        ...
        if (incomingAddressStore != null 
            ...
            try {
                ...
                ObjectFactory factory = ObjectFactory.getObjectFactory(
                        "em.sm.impl.siemens.sl45i.SiemensObjectFactory");
